...
<%
	...
	else
	{
		...
		if(left>=x){
			...
			int total=price*x;
			request.setCharacterEncoding("UTF-8");
			sql="insert into stock(id,name,price,img,amount,total,PID) values('"+(String)session.getAttribute("member")+"','"+request.getParameter("name")+"','"+price+"','"+request.getParameter("img")+"','"+num+"','"+total+"','"+request.getParameter("id")+"')";
